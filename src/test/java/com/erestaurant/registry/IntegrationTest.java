...
import com.erestaurant.registry.ERestaurantRegistryApp;
import com.erestaurant.registry.ReactiveSqlTestContainerExtension;
...
@SpringBootTest(classes = { ERestaurantRegistryApp.class, TestSecurityConfiguration.class })
